...
namespace Editor {
  ...
  DEDUCED_TYPE_IMPLEMENTATION_NUMERIC(int8_t, INTEGER1)
  DEDUCED_TYPE_IMPLEMENTATION_NUMERIC(int16_t, INTEGER1)
  DEDUCED_TYPE_IMPLEMENTATION_NUMERIC(int32_t, INTEGER1)
  DEDUCED_TYPE_IMPLEMENTATION_NUMERIC(int64_t, INTEGER1)
  DEDUCED_TYPE_IMPLEMENTATION_NUMERIC(uint8_t, INTEGER1)
  DEDUCED_TYPE_IMPLEMENTATION_NUMERIC(uint16_t, INTEGER1)
  DEDUCED_TYPE_IMPLEMENTATION_NUMERIC(uint32_t, INTEGER1)
  DEDUCED_TYPE_IMPLEMENTATION_NUMERIC(uint64_t, INTEGER1)
